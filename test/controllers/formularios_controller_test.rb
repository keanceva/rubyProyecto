...
class FormulariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create formulario" do
    assert_difference('Formulario.count') do
      post formularios_url, params: { formulario: { descripcion: @formulario.descripcion, fecha: @formulario.fecha, mascota: @formulario.mascota, nombre: @formulario.nombre, sexo: @formulario.sexo, telefono: @formulario.telefono } }
    end
  ...
  test "should update formulario" do
    patch formulario_url(@formulario), params: { formulario: { descripcion: @formulario.descripcion, fecha: @formulario.fecha, mascota: @formulario.mascota, nombre: @formulario.nombre, sexo: @formulario.sexo, telefono: @formulario.telefono } }
